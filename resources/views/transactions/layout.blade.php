...
<head>
    ...
    <link href="{{ asset('/plugins/Buttons/css/buttons.dataTables.min.css') }}" rel="stylesheet">
    <link href="{{ asset('/plugins/DateTime/css/dataTables.dateTime.min.css') }}" rel="stylesheet"> --}}
    ...
    <script type="text/javascript" src="{{ asset('/plugins/Buttons/js/buttons.dataTables.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('/plugins/DateTime/js/dataTables.dateTime.min.js') }}"></script> --}}
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    @else
                        ...
                        <li><a class="nav-link" href="{{ route('transaction.index') }}"> Transactions</a></li>
